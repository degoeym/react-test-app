            ...
            <div>
                ...
                <div className="row">
                    <div className="col-sm-2 col-xs-12 text-center">
                        <img className="img-responsive img-thumbnail" src={user.avatar_url} alt="Profile Image" title={user.name} />
                    </div>
                    <div className="col-sm-10 col-xs-12">
                        <span><b>Location: </b>{user.location}</span>
                        <br/>
                        <span><b>Email: </b><a href={`mailto:${user.email}`}></a></span>
                        <br/>
                        <span><b>Blog: </b><a href={user.blog}>{user.blog}</a></span>
                        <br/>
